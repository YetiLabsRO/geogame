...
class TeamTowerChallengeSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        # Appended after the pause/lockout checks so every pre-existing
        # rejection keeps its current precedence; under FREE_FOR_ALL this
        # is a no-op and simultaneous submissions stay permitted.
