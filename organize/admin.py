...
from organize.models import Game, Invite, TeamMembership, UserProfile
...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'current_game', 'created_at')
    search_fields = ('user__username', 'user__email', 'user__first_name', 'user__last_name')
    list_filter = ('current_game',)
    autocomplete_fields = ('user', 'current_game')
